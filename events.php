     ...
     <div class="container">
       <h1>Welcome <?php echo $row['name']?></h1>
		<br>
		 ...
		 <br>
         <button type="submit" class="button button2"><a href="beach.php"><h3>      Register for Atria campus Cleanup Drive</h3></a></button>
         <br>
		 <button type="submit" class="button button1"><a href="marathon.php"><h3>    Register for Plantation </h3></a></button>
         <br>
